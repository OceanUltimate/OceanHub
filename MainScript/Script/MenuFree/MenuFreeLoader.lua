...
for i,g in ipairs(GAMES) do
    local btn=Instance.new("TextButton"); btn.Size=UDim2.new(1,-24,0,40); btn.Position=UDim2.new(0,12,0,50+(i-1)*48); btn.BackgroundColor3=Color3.fromRGB(20,30,60); btn.Text=g.name; btn.TextColor3=Color3.fromRGB(255,255,255); btn.Font=Enum.Font.GothamBold; btn.TextSize=15; btn.Parent=card

--[[
    OceanHub - Phantom Ball Premium Script (FULL FEATURED)
    Task: Auto Deflect, Spam Deflect, Ball Predictor, WalkSpeed, Jump, Noclip, Premium Customizer
]]
...
RunService.RenderStepped:Connect(function()
    ...
    if Settings.SpamParry and dist <= 10 then
        doParry()
    end
end)
...
welcomeCard:AddBanner({ Text = "Kamu menggunakan Phantom Ball Premium Script.", Icon = "✦" })
welcomeCard:AddKeyVal({ Key = "Game Terdeteksi", Value = "Phantom Ball", Color = Color3.fromRGB(56, 189, 248) })
...
OceanLibrary:Notify({ Title = "OceanHub VIP", Content = "Phantom Ball Premium Script loaded!", Duration = 5 })
